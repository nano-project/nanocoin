...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("NanoCoins"));
    case mBTC: return QString(QObject::tr("Milli-NanoCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-NanoCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
